...
typedef SWIFT_ENUM(NSInteger, antispoofFaceThreshold, open) {
  antispoofFaceThresholdNONE = 0,
  antispoofFaceThresholdLOW = 1,
  antispoofFaceThresholdMEDIUM = 2,
  antispoofFaceThresholdMODERATE = 3,
  antispoofFaceThresholdBALANCEDHIGH = 4,
  antispoofFaceThresholdHIGH = 5,
  antispoofFaceThresholdBALANCEDVERYHIGH = 6,
  antispoofFaceThresholdVERY_HIGH = 7,
  antispoofFaceThresholdHIGHEST = 8,
};
